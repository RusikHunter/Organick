export const SERVICE_ID: string = "service_z4zipxo"
export const SERVICE_ID_ORDERS: string = "service_tq754ns"

export const TEMPLATE_ID_SUBSCRIBE: string = "template_jlxi2uz"
