            ...
            <div className="post-content__inner container">
                <div className="post-content__row row">
                    <div className="post-content__column column">
                        ...
                        <h2 className="post-content__title h2">Preferred Form of Vitamin D?</h2>
                        ...
                        <ul className="post-content__unordered-list">
                            <li className="post-content__unordered-list-item text">
                        ...
                        <blockquote className="post-content__blockquote">
