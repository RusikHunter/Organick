    ...
    return (
        ...
        >
            ...
            <div className="product-card__price-wrap">
                <span className="product-card__price--sale"><s>{productData.price}$</s></span>

                <span className="product-card__price">{productData.discountPrice}$</span>
                ...
                <div className="product-card__rate">
                    {Array.from({ length: 5 }).map((_, index) => (
                        <svg
                            ...
                            className={`${index > productData.rating ? 'product-card__star--empty' : ''}`}
                        >
